function drawSankey(data, svg, minLinkSize, width, height, filters, linkUnit) {
   ...
   // minLinkSize = 25;
    ...
    d3.selectAll('.link.leave').each(function (d) {
        ...
        thisLink.append('path')
            ...
            .style('stroke-width', d => Math.max(1, d.dy)); //no data attached to path elements, so .link data is used instead?
